...
sayHelloButton.addEventListener("mouseover", buttonClass)
// PROBLEM 3    
/*
...
sayHelloButton.addEventListener("mouseout", revertButton)
// PROBLEM 4
/*
...
const ohMy = () => {
    ...
    .then((res) => {
        ...
        document.body.appendChild(animalText)
        }
    })
}
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/awsmo')
    .then((res) => {
...
// CODE HERE
const query = () => {
    axios.get('http://localhost:3000/query-test/?dasjdlkj')
.then((res) => {
 console.log(res.data)
})
}
const queryBtn = document.querySelector("#query-button").addEventListener("click", query)
...
const button = document.querySelector("#button").addEventListener("submit", createFood)